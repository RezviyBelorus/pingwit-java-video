...
public class AlgoComplexityExample {
    public static void main(String[] args) {
        ...
        Мы с вами уже познакомились с массивами. Так вот получение элемента массива по индексу происходит за О(1),
        ...
        */
        ...
        Например, вывести массив на экран - это O(n), поиск нужного элемента тоже происходит за O(n).
